    ...
    <div className="px-6 py-6 space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <div className="h-[400px] bg-neutral-200 dark:bg-neutral-800 rounded-card border border-border" />
        </div>
        <div className="space-y-4">
          <div className="h-[180px] bg-neutral-200 dark:bg-neutral-800 rounded-card border border-border" />
          <div className="h-[180px] bg-neutral-200 dark:bg-neutral-800 rounded-card border border-border" />
        </div>
      </div>
    </div>
